...
VALUES
    ...
    ('Annual Plan', '499.99', 'yearly', 2);

INSERT INTO `user` (first_name, last_name, email, password, pictureURL, waiverSignature, status, membership_id, referral_id, club_id, qrcodeToken)
VALUES
    ('John', 'Doe', 'john.doe@example.com', 'userpass1', 'http://example.com/john.jpg', 'JohnD2025', 'active', 1, 'REF001', 'CLUB001', 'QR001'),
    ('Jane', 'Smith', 'jane.smith@example.com', 'userpass2', 'http://example.com/jane.jpg', 'JaneS2025', 'active', 2, 'REF002', 'CLUB002', 'QR002');

INSERT INTO clubs (title, logo_url, client_id, status, created_at, user_id, membership_id, club_tag, staff_id)
VALUES
    ('Fitness Club A', 'http://example.com/logoA.png', 1, 'active', CURRENT_TIMESTAMP, 1, 1, 'CLUB001', 1),
    ('Fitness Club B', 'http://example.com/logoB.png', 2, 'active', CURRENT_TIMESTAMP, 2, 2, 'CLUB002', 2);